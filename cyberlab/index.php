    ...
    <div class="container">
        ...
        <div class="desc">
            ...
            <ul>
                ...
                <li><strong>CSRF (Cross-Site Request Forgery):</strong> Trick users into unwanted actions. <a href="csrf_demo.php">Try CSRF Demo</a></li>
                <br>
            </ul>
        </div>
        <div class="lab-btns">
            <a href="xss_demo.php">XSS Demo</a>
            <a href="csrf_demo.php">CSRF Demo</a>
        </div>
    </div>
</body>
